...
if __name__ == "__main__":
    ...
    input_files = {
         "X2R1": "data/X2R1.xlsx", # Replace with your actual file path if needed
        "X2R3": "data/X2R3.xlsx",
        "X2R5": "data/X2R5.xlsx"
    }
    ...
    # ⚠️ Change the output path if you want the Excel result saved elsewhere
    format_output_to_excel(output, "output/RequirementEvolutionOutput.xlsx")
